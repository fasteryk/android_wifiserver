...
public class CameraFragment extends Fragment
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            if (frameCount == 1) {
                ...
                float fps = (float)1000/frameTime*30;
                Log.d(TAG, "fps: " + fps);
            }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ErrorDialog.newInstance("need camera permission")
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Log.d(TAG, "camera output format: " + Arrays.toString(map.getOutputFormats()));
                Log.d(TAG, "camera output size (yuv420p): " + Arrays.toString(map.getOutputSizes(ImageFormat.YUV_420_888)));
                Log.d(TAG, "camera output size (YV12): " + Arrays.toString(map.getOutputSizes(ImageFormat.YV12)));
                Log.d(TAG, "camera min frame duration: " + map.getOutputMinFrameDuration(ImageFormat.YUV_420_888, new Size(800, 600)));

                // The camera's FPS range
                ...
                Log.d(TAG, "largest width: " + largest.getWidth() + " largest height: " + largest.getHeight());

                mImageReader = ImageReader.newInstance(/*largest.getWidth()*/640, /*largest.getHeight()*/480,
    ...
    private void openCamera(int width, int height) {
        ...
        int write_permission =  ContextCompat.checkSelfPermission(getActivity(),
                    ...
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            ...
                            try {
                                ...
                                //mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AE_MODE, CONTROL_AE_MODE_OFF);
                                //mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AF_MODE, CONTROL_AF_MODE_OFF);
    ...
    private static class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                for (Image.Plane p: mImage.getPlanes()) {
